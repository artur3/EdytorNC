...
void SerialPortConfigDialog::changeSettings()
{
    ...
    bool state = settings.value("DetectFormFileName", true).toBool();
//    qDebug() << "**********************" << state;

    detectFormFileNameCheckBox->setChecked(state);
    userExpCheckBox->setChecked(!state);
...
void SerialPortConfigDialog::autoSaveCheckBoxChanged(int state)
{
    ...
    userExpCheckBox->setEnabled(state == Qt::Checked);
    fileNameExpASComboBox->setEnabled(state == Qt::Checked);
    addfileNameButton->setEnabled(state == Qt::Checked);
    removeFileNameButton->setEnabled(state == Qt::Checked);
...
void SerialPortConfigDialog::addMaskButtonClicked()
{
...
void SerialPortConfigDialog::removeMaskButtonClicked()
{
