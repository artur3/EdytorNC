...
//            qDebug() << "bBinaryAEqB: " << pTotalDiffStatus->bBinaryAEqB;
//            qDebug() << "bTextAEqB: " << pTotalDiffStatus->bTextAEqB;
//            qDebug() << "Diff: " << totalInfo;
//            qDebug() << "Diff: " << totalInfo;
    ...
    /* if ( bVisibleMergeResultWindow && m_pMergeResultWindow )
   {
    ...
    return pTotalDiffStatus->bBinaryAEqB;
}
...
void KDiff3App::initView()
{
   ...
   QAction *copyAct = new QAction(QIcon(":/images/edit-copy.svg"), tr("&Copy"), this);
