...
#ifndef SPFSMAINWINDOW_H
#define SPFSMAINWINDOW_H

#include <QMainWindow>
#include <QComboBox>

#include "../SerialPortCommon/serialtransmissiondialog.h"
#include "../SerialPortCommon/serialportconfigdialog.h"
#include "../FileChecker/filechecker.h"


namespace Ui
{
class SPFSMainWindow;
}

class SPFSMainWindow : public QMainWindow
{
    Q_OBJECT

public:
    explicit SPFSMainWindow(QWidget *parent = 0);
    ~SPFSMainWindow();
